...
export const uiTranslations: Record<SupportedLanguage, Record<string, string>> = {
    en: {
        ...
        organicVisits: 'Organic Visits Generated',
        yearsLearning: 'Year Learning & Practicing SEO',
        whatIDo: 'What I Do',
    ...
    zh: {
        ...
        projectsCompleted: '完成的项目（并持续增加）',
        organicVisits: '产生的自然访问',
        yearsLearning: '年学习与实践SEO',
        whatIDo: '我的服务',
